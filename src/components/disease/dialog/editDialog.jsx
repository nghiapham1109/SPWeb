...
export function EditDiseaseDialog(props) {
  ...
  //   let [symptomsUpdate, setSymptomsUpdate] = useState(
...
//   const { success: successEdit } = useSelector((state) => state.diseaseSave);
  ...
  const descriptionValidate = () => {
    if (
      descriptionUpdate.trim().length < 5 ||
      descriptionUpdate.trim().length > 5000
    ) {
